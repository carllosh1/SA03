...
<body>
 ...
 <?php
            ...
            $cmd = $con->query("SELECT * FROM tbl_especialidade ORDER BY codigo_especialidade");
            ...
            foreach ($res as $valor) {
                ...
                echo "<td>".$valor['codigo_especialidade']."</td>";
                echo "<td>".$valor['dataCadastro_especialidade']."</td>";
                echo "<td>".$valor['nome_especialidade']."</td>";
                
               
                echo "<td><a href='deletar.php?codigo_especialidade=".$valor['codigo_especialidade']."' class='white-text text-darken-2 waves-effect waves-light btn-small red darken-3'>Excluir
                <i class='material-icons right'>delete_sweep</i></a> </td>";
               
                echo "<td><a href='atualizar.php?codigo_especialidade=".$valor['codigo_especialidade']."' class='white-text text-darken-2 waves-effect waves-light  green darken-1 btn-small'>Atualizar
