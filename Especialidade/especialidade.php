...
<body>
    ...
    <nav>
        <div class="nav-wrapper deep-orange accent-1">
            ...
            <ul class="side-nav" id="menu-mobile">
                    ...
                    <li class="navbar-item">
                        <a href="../Padroes/padroes.php.php"> Padrões</a>
                    </li>
            </ul>
        </div>
    </nav>
    ...
    <form action="cadastro.php" method="post">
        <fieldset class="margin-border">
            ...
            <h4 class="title">Cadastro Especialdiades - COM CRUD</h4>
            <hr>
        ...
        <table class="flex">  
            <tr >    
                <td>
                    ...
                    <input type="date"  name="dataCadastroEspecialidade" required="required" id="dataCadastroEspecialidade" placeholder="dd/mm/aaaa">
                </td>   
            </tr>
        </table> 
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input type="text" name="nomeEspecialidade" id="nomeEspecialidade" placeholder="Nome especialidade" required="required"> 
